...
name: product-launch
description: >-
  Plan a product launch with the ORB framework (owned, rented, borrowed channels) and a
  five-phase rollout, plus Product Hunt strategy and pre/post-launch checklists. When the
  user wants to plan a product launch, feature announcement, or release strategy. Also use
...
4. Set up affiliate/referral incentives (for channel partner launches, use a partner CRM / deal-registration tool (e.g. Introw or equivalent) to manage deal registration and commissions)
