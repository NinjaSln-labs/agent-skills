---
name: k6-performance
description: Modern load testing with k6 including thresholds, scenarios, and custom metrics Use when load/performance testing with k6 (thresholds, scenarios, metrics).
version: 1.0.0
